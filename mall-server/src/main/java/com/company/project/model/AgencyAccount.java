...
public class AgencyAccount {
     ...
     * 密码
     */
    @Column(name = "AGENCY_PASS")
    private String agencyPass;

    /**
     * 客户来源 
     */
    @Column(name = "AGENCY_SOURCE")
    private Integer agencySource;
     ...
     * 获取密码
     *
     * @return AGENCY_PASS - 密码
     */
    public String getAgencyPass() {
        return agencyPass;
    }
     ...
     * @param agencyPass 密码
     */
    public void setAgencyPass(String agencyPass) {
     ...
     * 获取客户来源 
     *
     * @return AGENCY_SOURCE - 客户来源 
     */
    public Integer getAgencySource() {
        return agencySource;
    }
     ...
     * 设置客户来源 
     *
     * @param agencySource 客户来源 
     */
    public void setAgencySource(Integer agencySource) {
